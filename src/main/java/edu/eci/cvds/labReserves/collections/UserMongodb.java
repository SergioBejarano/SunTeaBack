 ...
 * This class is annotated with {@code @Document}
 * to specify the collection name in MongoDB.
 */
...
public  class UserMongodb extends User {
    ...
    /**
     * Constructs a new {@code UserMongodb} object from an existing
     * {@code User} instance.
     *
     * @param user The {@code User} object to be converted into a
     * {@code UserMongodb} instance.
     * @throws LabReserveException If an error occurs during the conversion.
     */
    public UserMongodb(final User user) throws LabReserveException {
        super(user.getId(), user.getName(), user.getMail(),
